...
redfishResponse = RequestURL.requestJSON(Addresses.MAIN_PAGE,False)

print("\nConnection Established")

#once connection is Established
#validate authentification credentials by requesting a locked page until the request is accepted
credentials = AuthRedFish.authenticate(address,False)
...
response = RequestURL.requestJSON(Addresses.SYSTEM_PAGE,True)
